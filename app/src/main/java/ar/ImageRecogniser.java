...
import ar.Constants.ImageProcessModeEnum;
import ar.Constants.ImageSourceModeEnum;
import ar.RubikFace.FaceRecognitionStatusEnum;
...
public class ImageRecogniser implements CvCameraViewListener2{
     ...
     * @param stateModel
     */
    public ImageRecogniser(AppStateMachine appStateMachine, StateModel stateModel) {
